export const s3Url = 'https://s3.amazonaws.com/bike-images-22/'
...
export const captchaSiteKey = '6Legp2EUAAAAAKZhVvBOIj-d6mbHGwrWBfPEoiMX'

export const SelectAll = 'all';
export const SelectNone = 'none';